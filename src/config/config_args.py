...
# data
parser.add_argument("--data", default=None, type=str, choices=["ultrasound"])
...
parser.add_argument('--scribble_sagittal', action="store_true")
parser.add_argument('--scribble_coronal', action="store_true")
parser.add_argument("--initial_seg", action="store_true")
parser.add_argument("--use_penn", action="store_true")
parser.add_argument("--sample_fn_fp_masks", action="store_true")
