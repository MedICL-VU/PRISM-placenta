...
class MaskDecoder3D(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.decoder = Unet_decoder(spatial_dims=3, out_channels=3,
                                    features=(32, 32, 64, 128, transformer_dim, 32), plain=True)
    ...
    def _predict_mask(self, upscaled_embedding, prompt_embeddings):
        ...
        masks = upscaled_embedding.view(b, c, x * y * z).view(b, -1, x, y, z)
